...
public interface TaskRepository extends JpaRepository<Task, Long> {
  Optional<Task> findByUserAndName(UserEntity user, String name);
  ...
  List<Task> findByUserAndDueDateEqualsAndCompletedDateIsNullAndCategoryOrderByDueDate(
          UserEntity user, LocalDate dueDate, Category category); // PENDING FOR AN EXACT DATE WITH CATEGORY
